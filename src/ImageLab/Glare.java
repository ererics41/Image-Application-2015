...
public class Glare extends Filters {
	private static JButton B1;
	private static JButton B2;
	private static JButton B3;
	private static JFrame frame;

	public Glare(String str,String des)
	{
		super(str,des);
	...
	private class handler implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if(e.getSource()==B1){
				...
				B1 =  new JButton("Red Glare");
				B1.addActionListener(new handler());
				B2 =  new JButton("Green Glare");
				B2.addActionListener(new handler());
				B3 =  new JButton("Blue Glare");
				...
				JLabel L1 = new JLabel("Select the color you want the glare to be");
